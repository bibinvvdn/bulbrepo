...
var DivName = ["btn_div1", "btn_div2", "btn_div3", "btn_div4", "btn_div5"];
var DisDiv = ["clk_div1", "clk_div2", "clk_div3", "clk_div4", "clk_div5"];
var LinkDiv = ["1-1", "2-1", "3-1", "4-1", "5-1"];
var PicName = ["Toggler1", "Toggler2", "Toggler3", "Toggler4", "Toggler5"];
var RightID = ["1-1", "1-2", "1-3", "2-1", "2-2", "2-3", "2-4", "2-5", "2-6", "3-1", "4-1", "4-2", "4-3", "4-4", "4-5", "4-6", "4-7", "4-8", "5-1", "5-2", "5-3"];
var RightPage = ["Uptime.html", "SetupTime.htm", "SetupAdvanced.htm", "Wireless.htm", "WSecurity.htm&unit=0&vap=0", "WMACFilter.htm&unit=0&vap=0", "WpsSetup.htm", "VLAN.htm", "AdvancedWSettings.htm", "ApMode.htm", "Administration.htm", "Log.htm", "Diagnostics.htm", "FactoryDefaults.htm", "FirmwareUpgrade.htm", "Reboot.htm", "ConfigManagement.htm", "CertManagement.htm", "Status.htm", "StatusWireless.htm", "StatusSys.htm"];
...
function SetPic(id, type) {
	if (type == 1) {
		document.getElementById(id).src = "./images/toggleD.gif";
		document.getElementById(id).title = home_collapse;
	}
	else {
		document.getElementById(id).src = "./images/toggleR.gif";
