...
/bin/sed -e "s/test/$ssid/" /etc/hostapd_AP2_temp2.conf > /mnt/hostapd_AP2_temp.conf        #modified

/bin/sed 7d /mnt/hostapd_AP1_temp.conf > /tmp1.conf                                                      
/bin/sed 7d /mnt/hostapd_AP2_temp.conf > /tmp2.conf                                                  
/bin/cp /tmp1.conf  /mnt/hostapd_AP1_temp.conf     
/bin/cp /tmp2.conf  /mnt/hostapd_AP2_temp.conf     
/bin/cat /channel.txt >> /mnt/hostapd_AP1_temp.conf
/bin/cat /channel.txt >> /mnt/hostapd_AP2_temp.conf
/bin/cp /mnt/hostapd_AP1_temp.conf  /mnt/hostapd_AP1.conf
/bin/cp /mnt/hostapd_AP2_temp.conf  /mnt/hostapd_AP2.conf                                                
...
sleep 6
ifconfig wlan2 up
/usr/local/bin/hostapd /mnt/hostapd_AP2.conf -B                 #modified
