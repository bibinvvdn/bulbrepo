...
unsigned int start_addr, end_addr;
	...
	start_addr= 0x80100000;
        end_addr= 0x87000000;
        puts("writting the values \r\n");
        for(i= start_addr; i< end_addr; i+=4)
	{
		*(unsigned int volatile *)i=i;

	}//
        puts("reading the values \r\n");
        for(i= start_addr; i< (end_addr+8); i+=4)
	{
		if(*(unsigned int volatile *)i != i)
		{
        	    puts("test failed \r\n");
