...
#define CONFIG_SF_DEFAULT_SPEED	25000000 //vvdn
#define CONFIG_CMD_I2C
#define CONFIG_CMD_IMXOTP

/* Enable below configure when supporting nand */
#define CONFIG_CMD_SF
#define CONFIG_SPI_FLASH_MACRONIX   //vvdn
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"bootargs_spi=setenv bootargs ${bootargs} "     \
                        "root=/dev/ram rw ramdisk_size=49000\0"        \		
		"bootcmd_spi=run bootargs_base bootargs_spi;"         \
		 "sf probe 0;sf read 0x80800000 0x100000 0x400000;" \
		 "sf read 0x81000000 0x500000 0x900000;bootm 0x80800000 0x81000000\0"  \ 
         "bootcmd_sec=sf read 0x80800000 0xe00000 0x400000;" \
           "sf read 0x81000000 0x1200000 0x900000;bootm 0x80800000 0x81000000\0"     \
		 "bootcmd=run bootcmd_spi;run bootcmd_sec\0" \
 ...
 */
 ...
 #define CONFIG_IMX_PWM                         /*PWM signal config*/
 #define IMX_PWM1_BASE    PWM1_BASE_ADDR        
 #define IMX_PWM2_BASE    PWM2_BASE_ADDR     
 #define IMX_PWM4_BASE	  PWM4_BASE_ADDR	/*PWM4 define*/
