...
static struct pwm_device pwm4 = {       /*PWM4 configuration*/
        .pwm_id = 3,
        .pwmo_invert = 0,
};
#if 0
static struct pwm_device pwm0 = {       //ap for PWM2
        .pwm_id = 1,            
        .pwmo_invert = 0,
};

static struct pwm_device pwm1 = {       //ap for PWM1
        .pwm_id = 0,
        .pwmo_invert = 0,
};
#endif
 ...
 * */
	...
	setup_uart();
        ...
        mxc_iomux_v3_setup_pad(MX6SL_PAD_FEC_REF_CLK__PWM4_PWMO);       /*PWM4 configration*/    
        imx_pwm_config(pwm4, 25000, 50000);
        imx_pwm_enable(pwm4);
#if 0
	mxc_iomux_v3_setup_pad(MX6SL_PAD_HSIC_STROBE__PWM2_PWMO);       //ap    
        imx_pwm_config(pwm0, 25000, 50000);
        imx_pwm_enable(pwm0);

	mxc_iomux_v3_setup_pad(MX6SL_PAD_LCD_DAT0__PWM1_PWMO);       //ap    
